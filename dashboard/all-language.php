...
$jumlahData = count(query("SELECT * FROM tbl_language"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = ( isset($_GET["halaman"]) ) ? $_GET["halaman"] : 1;
$awalData = ( $jumlahDataPerHalaman * $halamanAktif ) - $jumlahDataPerHalaman;

$account_users = query("SELECT * FROM tbl_language LIMIT $awalData, $jumlahDataPerHalaman");
			...
			<div class="row">
			  ...
			  <div class="table-responsive">
				...
				<?php foreach( $account_users as $row ) : ?>
					<tr>
					<th scope="row"><?= $i; ?></th>
					<td><?= htmlentities($row["Name_language"]); ?></td>
					<td><a href="" class="btn btn-primary">Tambah Bahasa</a></td>
					</tr>
				<?php $i++; ?>
				<?php endforeach; ?>
