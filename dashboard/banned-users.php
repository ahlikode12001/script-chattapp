...
$account_users = query("SELECT * FROM tbl_account WHERE ban_account = 'aktif' LIMIT $awalData, $jumlahDataPerHalaman");
...
<div class="content transition">
		<div class="container-fluid dashboard">
			<h3 class="container">Banned Users</h3>
			...
			<div class="row">
			  ...
			  <div class="table-responsive">
				...
				<?php foreach( $account_users as $row ) : ?>
                    ...
                    <td><?= htmlentities($row["ban_account"]); ?></td>
					<td><a href="details_ban.php?user_id=<?= $row['user_id'];?>">Edit</a></td>
					</tr>
				<?php $i++; ?>
				<?php endforeach; ?>
